        ...
        <Row>
         ...
         <Col lg='12'>
            <div className="food__category d-flex align-items-center justify-content-center gap-4">
              ...
              <button className={`d-flex align-items-center gap-2 ${category === 'CARNE' ? 'foodBtnActive' : '' } `}
                onClick={() => setCategory("CARNE")}>
                 <img src={foodCategoryImg01} alt="" /> Carne</button>
              
              <button className={`d-flex align-items-center gap-2 ${category === 'BEBIDA' ? 'foodBtnActive' : '' } `}
                onClick={() => setCategory("BEBIDA")}>
                 <img src={foodCategoryImg02} alt="" /> Bebida</button>

              <button className={`d-flex align-items-center gap-2 ${category === 'ACOMPANHAMENTO' ? 'foodBtnActive' : '' } `}
                onClick={() => setCategory("ACOMPANHAMENTO")}>
                 <img src={foodCategoryImg03} alt="" /> Acompanhamento</button>

              <button className={`d-flex align-items-center gap-2 ${category === 'SOBREMESA' ? 'foodBtnActive' : '' } `}
                onClick={() => setCategory("SOBREMESA")}>
                 <img src={foodCategoryImg04} alt="" /> Sobremesa</button>
            </div>
          </Col>
            ...
            <Col lg='6' md='6'>
              <div className="why__tasty-treat">
                <h2 className="tasty__treat-title mb-4">
                  Por que?! <span>Churrasqueada CPX</span>
                </h2>
          ...
          <Col lg="6" md="6">
            <div className="depoimento ">
                ...
                <p className="depoimento__desc">
                 ...
                 Ea, expedita quisquam! Repellendus totam ad, iure perspiciatis sapiente fugiat?
                </p>
