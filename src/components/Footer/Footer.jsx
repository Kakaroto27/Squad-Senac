    ...
    <Container>
      <Row>
        ...
        <h5 className="footer__title">Contato</h5>
          ...
          <ListGroupItem className="delivery__time-item border-0 ps-0">
              <p>Localizão: Nova Brasilia, Complexo do Alemão. </p>
            </ListGroupItem>
          ...
          <ListGroup>
            <ListGroupItem className="delivery__time-item border-0 ps-0">
              <span>Email: churrasqueadacpx@gmail.com</span>   
            </ListGroupItem>
          </ListGroup>
        </Col>
      ...
      <Row className="mt-5">
        ...
        <Col lg='6' md="6" >
          <p className="copyright__text">Copyright - 2023, website made by Churrasqueada CPX. All
            Rights Reserved.</p>
        </Col>
        <Col lg='6' md="6">
